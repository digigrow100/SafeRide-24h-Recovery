    ...
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 md:py-24">
      <div className="max-w-3xl">
        <div className="mb-4 flex items-center gap-3">
          ...
          <p className="font-sans text-xs font-semibold uppercase tracking-widest text-slate-700">
            HOW WE CAN HELP
          </p>
        </div>
        <h2 className="mb-6 font-display text-2xl font-bold leading-tight text-slate-900 sm:text-3xl md:text-4xl">
